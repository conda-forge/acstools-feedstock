...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/acstools-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11431&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/acstools-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `acstools` can be installed with:

```
conda install acstools
```

It is possible to list all of the versions of `acstools` available on your platform with:
